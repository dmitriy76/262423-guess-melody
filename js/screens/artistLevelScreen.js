...
import genreLevel from './genreLevelScreen';

const artistLevelModule = getElementFromTemplate(`
...
const answerForm = artistLevelModule.querySelector(`.main-list`);
...
export default artistLevelModule;
